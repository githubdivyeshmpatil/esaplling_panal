...
<div className="w-14">
...
</div>  <p className="font-bold text-sm">Digital Signage</p>
  <p className="text-xs text-gray-600">Pro AV performance for extra-large rooms</p>
                                ...
                                <Link to="/products/hdl310" className="block hover:underline space-y-1">
                                 <div className="w-14">
  <img src={pro1} alt="HDL410" className="w-full h-auto rounded" />
</div>
                              ...
                              <div className="space-y-5">
                                ...
                                <Link to="/products/hdl300" className="block hover:underline space-y-1">
                                 <div className="w-36">
  <img src={pro2} alt="HDL410" className="w-full h-auto rounded" />
</div>
 ...
 <div className="w-24">
  <img src={pro3} alt="HDL410" className="w-full h-auto rounded" />
</div>                                  <p className="font-bold text-sm">Impression- Series </p>
                              ...
                              <div className="space-y-5">
                                ...
                                <div className="space-y-1">
                                  <p className="font-bold text-sm">Dislpay panal technology</p>
                                  <p className="text-xs text-gray-600">Xtreme Media's LED Video walls are designed to deliver high quality imagery with a seamless viewing experience. Proudly designed in India, our indoor and outdoor LED displays can be installed at any location and cater to a multitude of industries, thereby increasing the interaction between the brand and the customer.</p>
                                </div>
                                <div className="space-y-1">
                              ...
                              <div className="space-y-5">
                                <Link to="/products/hdx" className="block hover:underline space-y-1">
                                  ...
                                  <p className="text-xs text-gray-600">Advanced audio for large spaces. Coming in 2026.</p>
                                </Link>
                              </div>
                            </>
                          )}
                  ...
                  <Link to={item.link} className="hover:text-gray-500 py-2 block">{item.name}</Link>
                )}
              </li>
            ))}
          </ul>
      ...
      {/* Mobile Dropdown */}
      {isOpen && (
        <div className="md:hidden bg-[#f8f8f8] shadow-md px-6 py-4 space-y-2">
          {navItems.map((item, index) => (
            <div key={index}>
              {item.dropdown ? (
                <>
                  ...
                  {mobileDropdown === index && (
                    <div className="ml-4 mt-2 space-y-3 text-sm text-gray-700 pb-2 text-start">
                      {item.dropdown.type === "product" && (
                        <>
  ...
  <img src={pro} alt="HDL410" className="h-8 w-28 rounded" />
                          ...
                          <Link to="/products/hdl310" className="block">
                            <img src="/images/hdl310.png" alt="HDL310" className="h-16 w-auto rounded mb-1" />
                            HDL310 system
                          </Link>
                          <Link to="/products/hdl300" className="block">
                            <img src="/images/hdl300.png" alt="HDL300" className="h-16 w-auto rounded mb-1" />
                            HDL300 system
                          </Link>
                          <Link to="/products/hdl200" className="block">
                            <img src="/images/hdl200.png" alt="HDL200" className="h-16 w-auto rounded mb-1" />
                            HDL200 system
                          </Link>
                          <Link to="/products/hdx" className="block">
                            <img src="/images/hdx.png" alt="HDX" className="h-16 w-auto rounded mb-1" />
                            HDX series
                          </Link>
                        </>
                      )}
                ...
                <Link to={item.link} className="block font-medium">{item.name}</Link>
              )}
            </div>
          ))}
        </div>
