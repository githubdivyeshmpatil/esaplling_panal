...
function Home() {
  ...
  <div className="absolute inset-0 z-20 flex items-center justify-start px-4 sm:px-6 md:px-10 lg:px-20 py-10 sm:py-20">
    <div className="text-white max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl text-left sm:text-left">
      <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-center sm:text-left">
        Empowering Modern Collaboration with Smart Conferencing
      </h1>

      <p className="mt-4 text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 leading-relaxed text-center sm:text-left">
        Easy display for every room type
      </p>

      <div className="mt-6 flex justify-center sm:justify-start">
        <button
          className="w-full sm:w-auto px-4 py-2 sm:px-6 sm:py-3 bg-[#09c] text-white font-semibold rounded-md shadow hover:bg-blue-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        >
          Know More
        </button>
      </div>
 ...
 <Heading title="Key Features" />
        ...
        <Heading title="Products that transforms your approach for future " />
        <ExploreCarousel />
        {/* Responsive Section */}
  ...
  <div className="text-left w-full px-2 sm:px-4">
    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-snug text-white">
      <span className="block">Transformation and adoptability for next move:</span>
  ...
  <div className="text-white max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl text-left sm:text-left">
    ...
    <div className="mt-6 flex justify-center sm:justify-start">
      <button
        className="px-6 py-3 text-sm sm:text-base bg-[#09c] text-white font-semibold rounded-md shadow hover:bg-blue-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
      >
        Know More
      </button>
    </div>
